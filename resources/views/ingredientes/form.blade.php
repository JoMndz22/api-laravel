<div class="form-row">
	...
	<div class="col-12 mb-4">
		...
		<input type="text" class="form-control {{ $errors->has('Nombre')? 'is-invalid' :'' }}" name="Nombre" id="Nombre" value="{{ isset($ingrediente->nombre)? $ingrediente->nombre : old('Nombre') }}" />
...
<div class="form-row">
	<div class="col-12 mb-4">
		...
		<input type="text" class="form-control {{ $errors->has('Precio')? 'is-invalid' :'' }}"  name="Precio" id="Precio" value="{{ isset($ingrediente->precio) ? $ingrediente->precio : old('Precio') }}"/>
